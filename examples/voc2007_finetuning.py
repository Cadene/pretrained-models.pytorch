...
def main():
    ...
    train_set = pretrainedmodels.datasets.Voc2007Classification(args.data, 'train', transform=tf_img)
    val_set = pretrainedmodels.datasets.Voc2007Classification(args.data, 'val', transform=tf_img)
    test_set = pretrainedmodels.datasets.Voc2007Classification(args.data, 'test', transform=tf_img)
